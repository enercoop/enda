...
class TestPowerPredictor(unittest.TestCase):
    ...
    def test_joblib(self):
        ...
        train_set, test_set, target_col = TestUtils.get_example_d_train_test_sets(source="river")
        ...
        file_path_joblib = os.path.join(TestUtils.EXAMPLE_D_DIR, "tmp_test_joblib_h2o_estimator.joblib")
