    ...
    def test_backtest(self):
        ...
        expected_output_score = pd.DataFrame(
            data=[
                ...
                pd.to_datetime(['2003-01-02', '2003-12-31', '2004-01-16', '2004-07-15']).tolist() + [1],
                [1.14292136, 0.01255906, 0.98635499, 3.27970403, 37.97724098, 0.59882608, -2.65982372e+00,
                 49.01153002] + pd.to_datetime(['2003-01-02', '2004-07-01', '2004-07-16', '2005-01-14']).tolist() + [2],
                [8.18732385, 0.07290751, 0.64485879, 39.0304432, 26.69567957, 0.35471052, -8.44856070e+01,
                 61.52276424] + pd.to_datetime(['2003-01-02', '2004-12-31', '2005-01-18', '2005-07-15']).tolist() + [3],
                [8.24789383, 0.08363784, 0.6795263, 38.48157249, 27.68732255, 0.41571257, -1.31376739e+02,
                 46.28708362] + pd.to_datetime(['2003-01-02', '2005-07-01', '2005-07-18', '2006-01-13']).tolist() + [4],
                [9.2608702, 0.11244811, 0.56334664, 30.52625499, 39.10286031, 0.54313922, -2.66806549e+02,
                 80.71559812] + pd.to_datetime(['2003-01-02', '2005-12-30', '2006-01-17', '2006-07-14']).tolist() + [5],
                [10.23554988, 0.12730966, 0.42421692, 28.35328834, 34.26207391, 0.48453803, -8.79942003e+01,
                 52.25896329] + pd.to_datetime(['2003-01-02', '2006-06-30', '2006-07-17', '2007-01-12']).tolist() + [6],
                [10.67757512, 0.1266696, 0.29131941, 29.76228873, 17.73775561, 0.20433729, -8.31820536e+00,
                 38.45528669] + pd.to_datetime(['2003-01-02', '2006-12-29', '2007-01-16', '2007-07-13']).tolist() + [7],
                [10.75172972, 0.12958557, 0.23976944, 29.7410903, 24.69344502, 0.27023469, -4.47675014e+01,
                 31.91738036] + pd.to_datetime(['2003-01-02', '2007-06-29', '2007-07-16', '2007-12-31']).tolist() + [8],
            ],
            columns=[
                'train_rmse', 'train_mape', 'train_r2', 'train_max_error', 'test_rmse',
                'test_mape', 'test_r2', 'test_max_error', 'train_start', 'train_end', 'test_start', 'test_end',
        ...
        expected_output_score = pd.DataFrame(
            data=[
                [11.6333802, 0.13902552, 0.23106242, 29.9894976, 18.08189214, 0.19193931, -7.54008242,
                 28.33828377] + pd.to_datetime(['2003-01-02', '2003-11-04', '2003-11-05', '2004-09-03']).tolist() + [1],
                [11.6333802, 0.13902552, 0.23106242, 29.9894976, 13.34857455, 0.2278849, -2.84896532,
                 29.9894976] + pd.to_datetime(['2003-01-02', '2004-09-03', '2004-09-07', '2005-07-05']).tolist() + [2],
                [11.6333802, 0.13902552, 0.23106242, 29.9894976, 5.94383282, 0.08607951, -5.45674813,
                 12.50177153] + pd.to_datetime(['2003-01-02', '2005-07-05', '2005-07-06', '2006-05-03']).tolist() + [3],
                [11.6333802, 0.13902552, 0.23106242, 29.9894976, 11.47453515, 0.1529912, -4.65579553,
                 22.40540847] + pd.to_datetime(['2003-01-02', '2006-05-03', '2006-05-04', '2007-03-05']).tolist() + [4],
                [11.6333802, 0.13902552, 0.23106242, 29.9894976, 10.37559205, 0.10084627, -1.29007294,
                 18.31345085] + pd.to_datetime(['2003-01-02', '2007-03-05', '2007-03-06', '2007-12-31']).tolist() + [5],
            ],
            columns=[
                'train_rmse', 'train_mape', 'train_r2', 'train_max_error', 'test_rmse',
                'test_mape', 'test_r2', 'test_max_error', 'train_start', 'train_end', 'test_start', 'test_end',
